            ...
            <div class="welcome-text-main">
                <div>
                    <div class="welcome-heding">
                        <h1 class="welcome-text-title"><?php echo esc_html__('Welcome to','ecommerce-store-elementor'); ?> <strong><?php echo esc_html__('Ecommerce Store Elementor Theme','ecommerce-store-elementor'); ?> </strong></h1>
                    </div>
                ...
                <div class="upgrade-button">
                    ...
                    <a class="button button-primary" href="<?php echo esc_url( 'https://www.mizanthemes.com/products/wp-theme-bundle' ); ?>"  target="_blank">
                        <?php esc_html_e( 'Theme Bundle', 'ecommerce-store-elementor' ); ?>
                    </a>
                </div>
            </div>
