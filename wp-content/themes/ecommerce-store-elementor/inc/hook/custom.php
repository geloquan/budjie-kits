...
if ( ! function_exists( 'ecommerce_store_elementor_footer_goto_top' ) ) :
	...
	function ecommerce_store_elementor_footer_goto_top() {
		...
		$ecommerce_store_elementor_show_progress_bar =
		ecommerce_store_elementor_get_option( 'ecommerce_store_elementor_progress_bar' );

		if ( true === $ecommerce_store_elementor_show_progress_bar ) :
			echo '<div id="elemento-progress-bar" class="theme-progress-bar top"></div>';
		endif;
